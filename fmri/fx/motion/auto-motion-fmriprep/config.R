...
# paths
confoundDir = '/projects/giuliani_lab/shared/PCSR/bids_data/derivatives/fmriprep'
summaryDir = '/projects/giuliani_lab/shared/PCSR/PCSR_scripts/fMRI/fx/motion/auto-motion-fmriprep/summary'
plotDir = '/projects/giuliani_lab/shared/PCSR/PCSR_scripts/fMRI/fx/motion/auto-motion-fmriprep/plots'
rpDir = '/projects/giuliani_lab/shared/PCSR/PCSR_scripts/fMRI/fx/motion/auto-motion-fmriprep/rp_txt'
...
study = 'PCSR'
subPattern = 'sub-(PC[0-9]{3})'
wavePattern = 'ses-wave([0-9]{1})' # just extract the number
taskPattern = 'task-(fla|food|gng)'
